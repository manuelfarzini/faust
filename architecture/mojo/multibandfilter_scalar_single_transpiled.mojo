...
struct mydsp(FaustDsp):
    ...
    def __init__(out dsp):
        ...
        dsp.vslider9 = 0.0
        dsp.entry19 = 0.0
        dsp.rec9 = Arr[F32, 3](fill=0.0)
        dsp.rec8 = Arr[F32, 3](fill=0.0)
        dsp.rec7 = Arr[F32, 3](fill=0.0)
        dsp.rec6 = Arr[F32, 3](fill=0.0)
        dsp.rec5 = Arr[F32, 3](fill=0.0)
        dsp.rec4 = Arr[F32, 3](fill=0.0)
        dsp.rec3 = Arr[F32, 3](fill=0.0)
        dsp.rec2 = Arr[F32, 3](fill=0.0)
        dsp.rec1 = Arr[F32, 3](fill=0.0)
    ...
    def instance_constants(mut dsp, read sample_rate: S32) -> None:
        ...
        dsp.const0 = (F32(3.1415927)) / (min(F32(1.92e+05), max(F32(1.0), F32(dsp.sample_rate))))
    ...
    def compute[dreal: DType](
        ...
        var slow0 = tan((dsp.const0) * (F32(dsp.entry0)))
        var slow1 = F32(dsp.entry1)
        var slow2 = (pow(F32(1e+01), -((F32(0.05)) * (F32(dsp.vslider0))))) / (slow1)
        var slow3 = (F32(1.0)) / (((slow0) * ((slow0) + (slow2))) + (F32(1.0)))
        var slow4 = (F32(2.0)) * ((pow_unrolled[2](slow0)) + (F32(-1.0)))
        var slow5 = tan((dsp.const0) * (F32(dsp.entry2)))
        var slow6 = F32(dsp.entry3)
        var slow7 = (pow(F32(1e+01), -((F32(0.05)) * (F32(dsp.vslider1))))) / (slow6)
        var slow8 = (F32(1.0)) / (((slow5) * ((slow5) + (slow7))) + (F32(1.0)))
        var slow9 = (F32(2.0)) * ((pow_unrolled[2](slow5)) + (F32(-1.0)))
        var slow10 = tan((dsp.const0) * (F32(dsp.entry4)))
        var slow11 = F32(dsp.entry5)
        var slow12 = (pow(F32(1e+01), -((F32(0.05)) * (F32(dsp.vslider2))))) / (slow11)
        var slow13 = (F32(1.0)) / (((slow10) * ((slow10) + (slow12))) + (F32(1.0)))
        var slow14 = (F32(2.0)) * ((pow_unrolled[2](slow10)) + (F32(-1.0)))
        var slow15 = tan((dsp.const0) * (F32(dsp.entry6)))
        var slow16 = F32(dsp.entry7)
        var slow17 = (pow(F32(1e+01), -((F32(0.05)) * (F32(dsp.vslider3))))) / (slow16)
        var slow18 = (F32(1.0)) / (((slow15) * ((slow15) + (slow17))) + (F32(1.0)))
        var slow19 = (F32(2.0)) * ((pow_unrolled[2](slow15)) + (F32(-1.0)))
        var slow20 = tan((dsp.const0) * (F32(dsp.entry8)))
        var slow21 = F32(dsp.entry9)
        var slow22 = (pow(F32(1e+01), -((F32(0.05)) * (F32(dsp.vslider4))))) / (slow21)
        var slow23 = (F32(1.0)) / (((slow20) * ((slow20) + (slow22))) + (F32(1.0)))
        var slow24 = (F32(2.0)) * ((pow_unrolled[2](slow20)) + (F32(-1.0)))
        var slow25 = tan((dsp.const0) * (F32(dsp.entry10)))
        var slow26 = F32(dsp.entry11)
        var slow27 = (pow(F32(1e+01), -((F32(0.05)) * (F32(dsp.vslider5))))) / (slow26)
        var slow28 = (F32(1.0)) / (((slow25) * ((slow25) + (slow27))) + (F32(1.0)))
        var slow29 = (F32(2.0)) * ((pow_unrolled[2](slow25)) + (F32(-1.0)))
        var slow30 = tan((dsp.const0) * (F32(dsp.entry12)))
        var slow31 = F32(dsp.entry13)
        var slow32 = (pow(F32(1e+01), -((F32(0.05)) * (F32(dsp.vslider6))))) / (slow31)
        var slow33 = (F32(1.0)) / (((slow30) * ((slow30) + (slow32))) + (F32(1.0)))
        var slow34 = (F32(2.0)) * ((pow_unrolled[2](slow30)) + (F32(-1.0)))
        var slow35 = tan((dsp.const0) * (F32(dsp.entry14)))
        var slow36 = F32(dsp.entry15)
        var slow37 = (pow(F32(1e+01), -((F32(0.05)) * (F32(dsp.vslider7))))) / (slow36)
        var slow38 = (F32(1.0)) / (((slow35) * ((slow35) + (slow37))) + (F32(1.0)))
        var slow39 = (F32(2.0)) * ((pow_unrolled[2](slow35)) + (F32(-1.0)))
        var slow40 = tan((dsp.const0) * (F32(dsp.entry16)))
        var slow41 = F32(dsp.entry17)
        var slow42 = (pow(F32(1e+01), -((F32(0.05)) * (F32(dsp.vslider8))))) / (slow41)
        var slow43 = (F32(1.0)) / (((slow40) * ((slow40) + (slow42))) + (F32(1.0)))
        var slow44 = (F32(2.0)) * ((pow_unrolled[2](slow40)) + (F32(-1.0)))
        var slow45 = tan((dsp.const0) * (F32(dsp.entry18)))
        var slow46 = F32(dsp.entry19)
        var slow47 = (pow(F32(1e+01), -((F32(0.05)) * (F32(dsp.vslider9))))) / (slow46)
        var slow48 = (F32(1.0)) / (((slow45) * ((slow45) + (slow47))) + (F32(1.0)))
        var slow49 = (F32(2.0)) * ((pow_unrolled[2](slow45)) + (F32(-1.0)))
        var slow50 = ((slow45) * ((slow45) - (slow47))) + (F32(1.0))
        var slow51 = (F32(1.0)) / (slow46)
        var slow52 = ((slow45) * ((slow45) + (slow51))) + (F32(1.0))
        var slow53 = (F32(1.0)) - ((slow45) * ((slow51) - (slow45)))
        var slow54 = ((slow40) * ((slow40) - (slow42))) + (F32(1.0))
        var slow55 = (F32(1.0)) / (slow41)
        var slow56 = ((slow40) * ((slow40) + (slow55))) + (F32(1.0))
        var slow57 = (F32(1.0)) - ((slow40) * ((slow55) - (slow40)))
        var slow58 = ((slow35) * ((slow35) - (slow37))) + (F32(1.0))
        var slow59 = (F32(1.0)) / (slow36)
        var slow60 = ((slow35) * ((slow35) + (slow59))) + (F32(1.0))
        var slow61 = (F32(1.0)) - ((slow35) * ((slow59) - (slow35)))
        var slow62 = ((slow30) * ((slow30) - (slow32))) + (F32(1.0))
        var slow63 = (F32(1.0)) / (slow31)
        var slow64 = ((slow30) * ((slow30) + (slow63))) + (F32(1.0))
        var slow65 = (F32(1.0)) - ((slow30) * ((slow63) - (slow30)))
        var slow66 = ((slow25) * ((slow25) - (slow27))) + (F32(1.0))
        var slow67 = (F32(1.0)) / (slow26)
        var slow68 = ((slow25) * ((slow25) + (slow67))) + (F32(1.0))
        var slow69 = (F32(1.0)) - ((slow25) * ((slow67) - (slow25)))
        var slow70 = ((slow20) * ((slow20) - (slow22))) + (F32(1.0))
        var slow71 = (F32(1.0)) / (slow21)
        var slow72 = ((slow20) * ((slow20) + (slow71))) + (F32(1.0))
        var slow73 = (F32(1.0)) - ((slow20) * ((slow71) - (slow20)))
        var slow74 = ((slow15) * ((slow15) - (slow17))) + (F32(1.0))
        var slow75 = (F32(1.0)) / (slow16)
        var slow76 = ((slow15) * ((slow15) + (slow75))) + (F32(1.0))
        var slow77 = (F32(1.0)) - ((slow15) * ((slow75) - (slow15)))
        var slow78 = ((slow10) * ((slow10) - (slow12))) + (F32(1.0))
        var slow79 = (F32(1.0)) / (slow11)
        var slow80 = ((slow10) * ((slow10) + (slow79))) + (F32(1.0))
        var slow81 = (F32(1.0)) - ((slow10) * ((slow79) - (slow10)))
        var slow82 = ((slow5) * ((slow5) - (slow7))) + (F32(1.0))
        var slow83 = (F32(1.0)) / (slow6)
        var slow84 = ((slow5) * ((slow5) + (slow83))) + (F32(1.0))
        var slow85 = (F32(1.0)) - ((slow5) * ((slow83) - (slow5)))
        var slow86 = ((slow0) * ((slow0) - (slow2))) + (F32(1.0))
        var slow87 = (F32(1.0)) / (slow1)
        var slow88 = ((slow0) * ((slow0) + (slow87))) + (F32(1.0))
        var slow89 = (F32(1.0)) - ((slow0) * ((slow87) - (slow0)))
        for var i0 in range(S32(0), count):
            var temp0 = (slow49) * (dsp.rec9[S32(1)])
            dsp.rec9[S32(0)] = (F32(input0[i0])) - ((slow48) * (((slow50) * (dsp.rec9[S32(2)])) + (temp0)))
...
def main() raises -> None:
    print("Faust to Mojo benchmark architecture\n")
